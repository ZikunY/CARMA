...
library(susieR,lib="/ifs/scratch/msph/eigen/zy2412/R_libs/")
library(CARMA,lib="/ifs/scratch/msph/eigen/zy2412/R_libs/" )
rm(list=ls())
...
#whole.deepsea<-read.table(paste0('/Volumes/My_Passport/1000Genome/tenth_dataset/deepsea/',paste0('chr',chr),'/infile.vcf.out.evalue'),sep = ',',header=T)
...
for(i in chor.index){
    ...
    if(!dir.exists(paste0('/ifs/scratch/msph/eigen/zy2412/Bayesian_Fine_Mapping/Simulated_genotype/new_2022/',batch.index[num.causal],'/',
                          'data/data_plot/'))){
      dir.create(paste0('/ifs/scratch/msph/eigen/zy2412/Bayesian_Fine_Mapping/Simulated_genotype/new_2022/',batch.index[num.causal],'/',
                        'data/data_plot/'),recursive = T)
    }
    setwd(paste0('/ifs/scratch/msph/eigen/zy2412/Bayesian_Fine_Mapping/Simulated_genotype/new_2022/',batch.index[num.causal],'/'))
